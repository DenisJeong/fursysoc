...
<head>
	...
	<link rel="stylesheet" href="../product/css/fonts.css" type="text/css" media="all" />
	<link rel="stylesheet" href="../product/css/style.css" type="text/css" media="all" />
	<script type="text/javascript" src="../product/js/jquery.min.js"></script>
	<script type="text/javascript" src="../product/js/jquery.watermark.min.js"></script>
...
//임시로 수량을 정하기 위해
$product_quantity = mb_substr($p3,1) . $p4;
...
<div class="product-wrap  cf">
	<div class="product-wrap_left">
		<img class="product-background_for-narrow" src="../product/images/product-background.png"  />
		<img class="product-image" src="../product/images/<?php echo $product['image']?>" />
		<img class="product-co-logo" src="../product/images/product-co-logo.jpg" />
	</div>
	<div class="product-wrap-right">
		<table class="product-table">
			...
			<tr>
				<th>보유 총 수량</th>
				<td><?php echo $product_quantity ?>개</td>
			</tr>
			<tr>
				<th>층별 보유 수량</th>
				<td>3층<input class="checkbox" type="checkbox" />
					5층<input class="checkbox" type="checkbox" />
					6층<input class="checkbox" type="checkbox" />
					7층<input class="checkbox" type="checkbox" />
					8층<input class="checkbox" type="checkbox" />
					9층<input class="checkbox" type="checkbox" />
					10층<input class="checkbox" type="checkbox" />
					11층<input class="checkbox" type="checkbox" />
					12층<input class="checkbox" type="checkbox" />
					13층<input class="checkbox" type="checkbox" />
					14층<input class="checkbox" type="checkbox" />
					15층<input class="checkbox" type="checkbox" />
					16층<input class="checkbox" type="checkbox" />
					<input class="submit" type="submit" value="확인"/>
				</td>
			</tr>
			<tr>
				<th>최근구매 이력</th>
				<td>2016년 11월 / 퍼시스오피스컨설팅그룹</td>
			</tr>
			<tr>
				<th>최근구매 단위가격</th>
				<td>236,000원</td>
