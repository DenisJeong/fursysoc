...
var uname = escape("퍼시스오피스컨설턴트");
document.write(unescape("%3Cscript id='log_script' src='" + JsHost + "chevalier.weblog.cafe24.com/weblog.js?uid=chevalier&uname="+uname+"' type='text/javascript'%3E%3C/script%3E"));
</script>
<!-- 리포트2.0  로그분석코드 완료 -->
