<div class="catalog clear-fix">
    <a class="catalog-button" href="">상담 신청 / 제품 카탈로그 신청 / 빠른상담전화 (010-9268-6874)</a>
    <div class="catalog-form-wrap">
      <p style="margin-left: 9em; font-size: 11px;">*표시 항목은 필수 입력 사항입니다.</p>
        <form action="catalog-ocmall-action.php" method="post">
            <table>
                <tr>
                    <th scope="row">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <input type="checkbox" name="신청목적[]" id="제품상담" value="제품상담">
                           
                          <label for="제품 상담">제품 상담</label>
                        
                            <input type="checkbox" name="신청목적[]" id="컨설팅" value="컨설팅">
                           
                          <label for="컨설팅">사무환경컨설팅 상담</label>  
                        </div>
                        <div>
                            ...
                            <input type="checkbox" name="신청목적[]" id="랩" value="랩 카탈로그"><label for="랩">랩(연구실) 카탈로그</label>
                        </div>
